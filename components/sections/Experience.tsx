      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-8 mb-20">
          {featured.map((exp) => (
            <Card
              key={exp.id}
              className="border-0 shadow-sm hover:shadow-md transition-all duration-300 rounded-[2rem] overflow-hidden bg-card"
            >
        ...
        {others.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {others.map((exp) => (
              <Card
                key={exp.id}
                className="border-0 shadow-sm hover:shadow-md transition-all rounded-[2rem] bg-card h-full"
              >
